...
# import function
from csv_file import csvfl
from csv_column import csvcol
...
class TestCsvColumn(unittest.TestCase):
    ...
    def testCsv_csvcol_combined_test(self):
        result, msg, source, countRows, countColumns = csvfl.csvfl_csvToDataFrame(dataPath, 1)

        result, msg, headerColumnNumber = csvcol.csvcol_getHeaderColumnNumber(source, "町村")
        self.assertEqual((1, "Complete.", 4), (result, msg, headerColumnNumber))

        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_countEvery(source, [2,5])
        self.assertEqual((1, "Complete.", 48, 3), (result, msg, countRows, countColumns)) 

        result, msg, newName = csvfl.csvfl_dataFrameToCsv(data_actual, 1, True, dataDir, "output_csvcol_combined_test_1.csv")
        self.assertEqual((1, "Complete.",  "output_csvcol_combined_test_1.csv"), (result, msg, newName))

        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_deleteColumns(source, [6,4,2])
        self.assertEqual((1, "Complete.", countRows, 4), (result, msg, countRows, countColumns))

        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_duplicateColumn(source, 1, 0, "Duplicated")
        self.assertEqual((1, "Complete.", countRows, 5), (result, msg, countRows, countColumns))

        result, msg, newName = csvfl.csvfl_dataFrameToCsv(data_actual, 1, True, dataDir, "output_csvcol_combined_test_2.csv")
        self.assertEqual((1, "Complete.",  "output_csvcol_combined_test_2.csv"), (result, msg, newName))

        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_fillRandomNumber(source, [1,3,5], 8, True)
        self.assertEqual((1, "Complete.", countRows, countColumns), (result, msg, countRows, countColumns))

        result, msg, newName = csvfl.csvfl_dataFrameToCsv(data_actual, 1, True, dataDir, "output_csvcol_combined_test_3.csv")
        self.assertEqual((1, "Complete.",  "output_csvcol_combined_test_3.csv"), (result, msg, newName))

        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_fillSequentialNumber(source, [1,3,5], 8, True)
        self.assertEqual((1, "Complete.", countRows, countColumns), (result, msg, countRows, countColumns))

        result, msg, newName = csvfl.csvfl_dataFrameToCsv(data_actual, 1, True, dataDir, "output_csvcol_combined_test_4.csv")
...
# PG_21
    ...
    def testCsv_csvcol_getHeaderColumnNumber1(self):
        result, msg, headerColumnNumber = csvcol.csvcol_getHeaderColumnNumber(self.source_invalid, "ﾔﾏｸﾞﾁｹﾝ")
    ...
    def testCsv_csvcol_getHeaderColumnNumber2(self):
        result, msg, headerColumnNumber = csvcol.csvcol_getHeaderColumnNumber(self.source_empty, "ﾔﾏｸﾞﾁｹﾝ")
    ...
    def testCsv_csvcol_getHeaderColumnNumber3(self):
        result, msg, headerColumnNumber = csvcol.csvcol_getHeaderColumnNumber(self.source, 12345)
    ...
    def testCsv_csvcol_getHeaderColumnNumber4(self):
        result, msg, headerColumnNumber = csvcol.csvcol_getHeaderColumnNumber(self.source, "ﾃｽﾄ")
    ...
    def testCsv_csvcol_getHeaderColumnNumber5(self):
        result, msg, headerColumnNumber = csvcol.csvcol_getHeaderColumnNumber(self.source, "ヤマグチケン")
    ...
    def testCsv_csvcol_getHeaderColumnNumber6(self):
        result, msg, headerColumnNumber = csvcol.csvcol_getHeaderColumnNumber(self.source, "33")
    ...
    def testCsv_csvcol_getHeaderColumnNumber7(self):
        result, msg, headerColumnNumber = csvcol.csvcol_getHeaderColumnNumber(self.source, "ABC")
    ...
    def testCsv_csvcol_getHeaderColumnNumber8(self):
        result, msg, headerColumnNumber = csvcol.csvcol_getHeaderColumnNumber(self.source_header_number, "9")
    ...
    def testCsv_csvcol_getHeaderColumnNumber9(self):
        result, msg, headerColumnNumber = csvcol.csvcol_getHeaderColumnNumber(self.source, "設問番号")
        self.assertEqual((1, "Complete.", 3), (result, msg, headerColumnNumber)) 

    # 処理が問題なく完了した
    def testCsv_csvcol_getHeaderColumnNumber10(self):
        result, msg, headerColumnNumber = csvcol.csvcol_getHeaderColumnNumber(self.source, "集計日")
...
# PG_22
    ...
    def testCsv_csvcol_getHeaderName1(self):
        result, msg, headerName = csvcol.csvcol_getHeaderName(self.source_invalid, 2)
        self.assertEqual((0, "Error : The source was invalid format.", ""), (result, msg, headerName))

    # sourceがNULL
    def testCsv_csvcol_getHeaderName2(self):
        result, msg, headerName = csvcol.csvcol_getHeaderName(self.source_empty, 2)
    ...
    def testCsv_csvcol_getHeaderName3(self):
        result, msg, headerName = csvcol.csvcol_getHeaderName(self.source, "2")
        self.assertEqual((-1, "Error : An unexpected error occurred.", ""), (result, msg, headerName))

    # headerが見つからない
    def testCsv_csvcol_getHeaderName4(self):
        result, msg, headerName = csvcol.csvcol_getHeaderName(self.source, 0)
    ...
    def testCsv_csvcol_getHeaderName5(self):
        result, msg, headerName = csvcol.csvcol_getHeaderName(self.source, 10)
...
# PG_23
    ...
    def testCsv_csvcol_deleteColumn1(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_deleteColumn(self.source_invalid, 2)
    ...
    def testCsv_csvcol_deleteColumn2(self):
        data_expected = pandas.DataFrame()
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_deleteColumn(self.source_empty, 2)
    ...
    def testCsv_csvcol_deleteColumn3(self):
        data_expected = pandas.DataFrame()
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_deleteColumn(self.source, "2")
    ...
    def testCsv_csvcol_deleteColumn4(self):
        data_expected = pandas.DataFrame()
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_deleteColumn(self.source, 0)
    ...
    def testCsv_csvcol_deleteColumn5(self):
        data_expected = pandas.DataFrame()
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_deleteColumn(self.source, 10)
    ...
    def testCsv_csvcol_deleteColumn6(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_deleteColumn(self.source, 3)
    ...
    def testCsv_csvcol_deleteColumn7(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_deleteColumn(self.source, 1)
        self.assertEqual((1, "Complete.", 7, 8), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testCsv_csvcol_deleteColumn8(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_deleteColumn(self.source, 9)
        self.assertEqual((1, "Complete.", 7, 8), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testCsv_csvcol_deleteColumn9(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_deleteColumn(self.source_header_number, 5)
...
# PG_24
    ...
    def testCsv_csvcol_deleteColumns1(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_deleteColumns(self.source_invalid, columnNumbers)
        self.assertEqual((0, "Error : The source was invalid format.", 0, 0), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testCsv_csvcol_deleteColumns2(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_deleteColumns(self.source_empty, columnNumbers)
        self.assertEqual((0, "Error : The source was empty.", 0, 0), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testCsv_csvcol_deleteColumns3(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_deleteColumns(self.source, columnNumbers)
        self.assertEqual((-1, "Error : An unexpected error occurred.", 0, 0), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testCsv_csvcol_deleteColumns11(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_deleteColumns(self.source_header_number, columnNumbers)
...
# PG_25
    ...
    def testCsv_csvcol_duplicateColumn1(self):
        data_expected = pandas.DataFrame()
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_duplicateColumn(self.source_invalid, 2, 10, "採点完了件数")
        self.assertEqual((0, "Error : The source was invalid format.", 0, 0), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testCsv_csvcol_duplicateColumn2(self):
        data_expected = pandas.DataFrame()
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_duplicateColumn(self.source_empty, 2, 10, "採点完了件数")
        self.assertEqual((0, "Error : The source was empty.", 0, 0), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testCsv_csvcol_duplicateColumn3(self):
        data_expected = pandas.DataFrame()
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_duplicateColumn(self.source, "2", 10, "採点完了件数")
        self.assertEqual((-1, "Error : An unexpected error occurred.", 0, 0), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testCsv_csvcol_duplicateColumn4(self):
        data_expected = pandas.DataFrame()
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_duplicateColumn(self.source, 0, 5, "採点完了件数")
    ...
    def testCsv_csvcol_duplicateColumn5(self):
        data_expected = pandas.DataFrame()
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_duplicateColumn(self.source, 10, 5, "採点完了件数")
    ...
    def testCsv_csvcol_duplicateColumn6(self):
        data_expected = pandas.DataFrame()
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_duplicateColumn(self.source, 2, "5", "採点完了件数")
        self.assertEqual((-1, "Error : An unexpected error occurred.", 0, 0), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testCsv_csvcol_duplicateColumn7(self):
        data_expected = pandas.DataFrame()
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_duplicateColumn(self.source, 2, -1, "採点完了件数")
    ...
    def testCsv_csvcol_duplicateColumn9(self):
        data_expected = pandas.DataFrame()
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_duplicateColumn(self.source, 2, 10, 123)
        self.assertEqual((-1, "Error : An unexpected error occurred.", 0, 0), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testCsv_csvcol_duplicateColumn10(self):
        data_expected = pandas.DataFrame()
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_duplicateColumn(self.source, 2, 3, "集計日")
    ...
    def testCsv_csvcol_duplicateColumn11(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_duplicateColumn(self.source, 2, 5, "採点完了件数2")
    ...
    def testCsv_csvcol_duplicateColumn12(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_duplicateColumn(self.source, 2, 0, "採点完了件数2")
        self.assertEqual((1, "Complete.", 7, 10), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testCsv_csvcol_duplicateColumn13(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_duplicateColumn(self.source_header_number, 2, 0, "10")
    ...
    def testCsv_csvcol_duplicateColumn14(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_duplicateColumn(self.source, 1, 1, "集計日2")
        self.assertEqual((1, "Complete.", 7, 10), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testCsv_csvcol_duplicateColumn15(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_duplicateColumn(self.source, 5, 2, "採点完了件数2")
        self.assertEqual((1, "Complete.", 7, 10), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
...
#PG_42
    ...
    def testCsv_csvcol_countEvery1(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_countEvery(self.source_invalid, keyColumnNumbers)
        self.assertEqual((0, "Error : The source was invalid format.", 0, 0), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testCsv_csvcol_countEvery2(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_countEvery(self.source_empty, keyColumnNumbers)
        self.assertEqual((0, "Error : The source was empty.", 0, 0), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testCsv_csvcol_countEvery3(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_countEvery(self.source, keyColumnNumbers)
        self.assertEqual((-1, "Error : An unexpected error occurred.", 0, 0), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testCsv_csvcol_countEvery11(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_countEvery(self.source_header_number, keyColumnNumbers)
...
#PG_51
    ...
    def testCsv_csvcol_deleteColumnsExcept1(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_deleteColumnsExcept(self.source_invalid, columnNumbers)
        self.assertEqual((0, "Error : The source was invalid format.", 0, 0), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testCsv_csvcol_deleteColumnsExcept2(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_deleteColumnsExcept(self.source_empty, columnNumbers)
        self.assertEqual((0, "Error : The source was empty.", 0, 0), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testCsv_csvcol_deleteColumnsExcept3(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_deleteColumnsExcept(self.source, columnNumbers)
        self.assertEqual((-1, "Error : An unexpected error occurred.", 0, 0), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testCsv_csvcol_deleteColumnsExcept12(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_deleteColumnsExcept(self.source_header_number, columnNumbers)
...
# PG_52
    ...
    def testCSV_csvcol_getHeaderColumnNumberPartialMatch1(self):
        result, msg, headerColumnNumber = csvcol.csvcol_getHeaderColumnNumberPartialMatch(self.source_invalid, "設問")
    ...
    def testCSV_csvcol_getHeaderColumnNumberPartialMatch2(self):
        result, msg, headerColumnNumber = csvcol.csvcol_getHeaderColumnNumberPartialMatch(self.source_empty, "設問")
    ...
    def testCSV_csvcol_getHeaderColumnNumberPartialMatch3(self):
        result, msg, headerColumnNumber = csvcol.csvcol_getHeaderColumnNumberPartialMatch(self.source, 12345)
    ...
    def testCSV_csvcol_getHeaderColumnNumberPartialMatch4(self):
        result, msg, headerColumnNumber = csvcol.csvcol_getHeaderColumnNumberPartialMatch(self.source_header_number, "3")
        self.assertEqual((-1, "Error : An unexpected error occurred.", []), (result, msg, headerColumnNumber))

    # [headerName]が空白の場合
    def testCSV_csvcol_getHeaderColumnNumberPartialMatch5(self):
        result, msg, headerColumnNumber = csvcol.csvcol_getHeaderColumnNumberPartialMatch(self.source, "")
        self.assertEqual((-1, "Error : An unexpected error occurred.", []), (result, msg, headerColumnNumber))

    # [headerName]が見つからない
    # Error: headerName input 1 byte
    def testCSV_csvcol_getHeaderColumnNumberPartialMatch6(self):
        result, msg, headerColumnNumber = csvcol.csvcol_getHeaderColumnNumberPartialMatch(self.source, "ﾃｽﾄ")
    ...
    def testCSV_csvcol_getHeaderColumnNumberPartialMatch7(self):
        result, msg, headerColumnNumber = csvcol.csvcol_getHeaderColumnNumberPartialMatch(self.source, "ヤマグチケン")
    ...
    def testCSV_csvcol_getHeaderColumnNumberPartialMatch8(self):
        result, msg, headerColumnNumber = csvcol.csvcol_getHeaderColumnNumberPartialMatch(self.source, "33")
    ...
    def testCSV_csvcol_getHeaderColumnNumberPartialMatch9(self):
        result, msg, headerColumnNumber = csvcol.csvcol_getHeaderColumnNumberPartialMatch(self.source, "ABC")
    ...
    def testCSV_csvcol_getHeaderColumnNumberPartialMatch10(self):
        result, msg, headerColumnNumber = csvcol.csvcol_getHeaderColumnNumberPartialMatch(self.source, "設問")
        self.assertEqual((1, "Complete.", [3, 4]), (result, msg, headerColumnNumber))

    # 処理が問題なく完了した
    def testCSV_csvcol_getHeaderColumnNumberPartialMatch11(self):
        result, msg, headerColumnNumber = csvcol.csvcol_getHeaderColumnNumberPartialMatch(self.source, "数")
...
#Test for svcol_fillRandomNumber
    ...
    def testCsv_svcol_fillRandomNumber1(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_fillRandomNumber(self.source_invalid, columnNumbers, 8, True)
        self.assertEqual((0, "Error : The source was invalid format.", 0, 0), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testCsv_svcol_fillRandomNumber2(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_fillRandomNumber(self.source_empty, columnNumbers, 8, True)
        self.assertEqual((0, "Error : The source was empty.", 0, 0), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testCsv_svcol_fillRandomNumber3(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_fillRandomNumber(self.source, columnNumbers, 8, True)
        self.assertEqual((-1, "Error : An unexpected error occurred.", 0, 0), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
...
#Test for svcol_fillSequentialNumber
    ...
    def testCsv_svcol_fillSequentialNumber1(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_fillSequentialNumber(self.source_invalid, columnNumbers, 8, True)
        self.assertEqual((0, "Error : The source was invalid format.", 0, 0), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testCsv_svcol_fillSequentialNumber2(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_fillSequentialNumber(self.source_empty, columnNumbers, 8, True)
        self.assertEqual((0, "Error : The source was empty.", 0, 0), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testCsv_svcol_fillSequentialNumber3(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_fillSequentialNumber(self.source, columnNumbers, 8, True)
        self.assertEqual((-1, "Error : An unexpected error occurred.", 0, 0), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testCsv_svcol_fillSequentialNumber12(self):
        ...
        result, msg, data_actual, countRows, countColumns = csvcol.csvcol_fillSequentialNumber(self.source, columnNumbers, 8, False)
        self.assertEqual((1, "Complete.", 7, 9), (result, msg, countRows, countColumns))
        assert_frame_equal(data_actual, data_expected)
    ...
    def testPerformance(self):
        result_csv, msg_csv, source, countRows_csv, countColumns_csv = csvfl.csvfl_csvToDataFrame(dataPath, 1)

        # function csvcol_getHeaderColumnNumber
        start = time.time()
        result, msg, headerColumnNumber = csvcol.csvcol_getHeaderColumnNumber(source, "headername")
        end = time.time()
        print("Time test function csvcol_getHeaderColumnNumber: " + str(end - start))

        # function csvcol_getHeaderName
        start = time.time()
        result, msg, headerName = csvcol.csvcol_getHeaderName(source, 200)
        end = time.time()
        print("Time test function csvcol_getHeaderName: " + str(end - start))

        # function csvcol_deleteColumn
        start = time.time()
        result, msg, newData, countRows, countColumns = csvcol.csvcol_deleteColumn(source, 2)
        end = time.time()
        print("Time test function csvcol_deleteColumn: " + str(end - start))

        # function csvcol_deleteColumns
        start = time.time()
        result, msg, newData, countRows, countColumns = csvcol.csvcol_deleteColumns(source, [1,2,3,4,5,6])
        end = time.time()
        print("Time test function csvcol_deleteColumns: " + str(end - start))

        # function csvcol_duplicateColumn
        start = time.time()
        result, msg, newData, countRows, countColumns = csvcol.csvcol_duplicateColumn(source, 2, 5, "教科2")
        end = time.time()
        print("Time test function csvcol_duplicateColumn: " + str(end - start))

        # function csvcol_countEvery
        start = time.time()
        result, msg, newData, countRows, countColumns = csvcol.csvcol_countEvery(source, [1,2,3])
        end = time.time()
